...
class Annotator:
    ...
    # YOLOv5 Annotator for train/val mosaics and jpgs and detection/hub inference annotations
...
def feature_visualization(x, module_type, stage, n=32, save_dir=Path('runs/detection/exp')):
    """
